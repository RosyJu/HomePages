------------------------------template------------------------------
<template>
    <div class="item" v-for="key in item" :mark="key.id" :style="{ background: key.background }">
        <a :href="`https://${key.href}`" target="_blank">
            <el-image :src="`/src/assets/images/index/out_web/${key.src}.${key.suffix}`">
                <template #error>
...
const item = ref([
    {id:id++,src:"deepseek",suffix:"svg",href:"deepseek.com"},{id:id++,src:"doubao",suffix:"png",href:"doubao.com"},{id:id++,src:"chaoxing",suffix:"svg",background:"rgb(219, 50, 29)",href:"i.chaoxing.com/"}
])
